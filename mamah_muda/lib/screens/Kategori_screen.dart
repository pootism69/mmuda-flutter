...
class MyKategori extends StatelessWidget {
  const MyKategori({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyKategoriPage(title: 'Kategori'),
...
class MyKategoriPage extends StatefulWidget {
  MyKategoriPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  KategoriScreen createState() => KategoriScreen();
}

class KategoriScreen extends State<MyKategoriPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //Model: resep
                  //Backend: daftar resep di kategori
                  SizedBox(
                    height: 800,
