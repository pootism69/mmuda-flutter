...
class MyRecipeScreen extends State<MyRecipePage> {
  ...
  Future<void> retrievePosts() async {
    ...
    if (response.error == null) {
      setState(() {
        resepsayaList = response.data as List<dynamic>;
      });
    } else {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: resepsayaList.length,
                      itemBuilder: (BuildContext context, int index) {
                        final card = resepsayaList[index];
                        final String namaResep = card.name;
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: AssetImage(
                                                'assets/images/ListKategori/Cemilan.png'),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
