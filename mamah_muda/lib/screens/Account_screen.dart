...
class AccountScreen extends State<MyAccountPage> {
  ...
  Future<void> _loadUserDetails() async {
    ...
    print('Name from SharedPreferences: $name'); // Debug line
    print('Email from SharedPreferences: $email'); // Debug line
    setState(() {
      username = name ?? '';
      useremail = email ?? '';
    });
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            // Setelah kembali dari EditAkun(), atur selected kembali ke 4
                            setState(() {
                              selected = 4;
                            });
                          });
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            // Setelah kembali dari MyRecipe(), atur selected kembali ke 4
                            setState(() {
                              selected = 4;
                            });
                          });
