...
class MyFavorite extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyFavoritePage(title: 'Favorit'),
...
class MyFavoritePage extends StatefulWidget {
  MyFavoritePage({Key? key, required this.title}) : super(key: key);
  final String title;
...
class FavoriteScreen extends State<MyFavoritePage> {
  int selected = 3;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    //Model : resep
                    //Backend: Daftar resep di favorit
                    height: 800, // Sesuaikan tinggi sesuai kebutuhan Anda
