...
class MyViral extends StatelessWidget {
  const MyViral({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyViralPage(title: 'Viral'),
      debugShowCheckedModeBanner: false,
    );
  }
}

class MyViralPage extends StatefulWidget {
  MyViralPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  ViralScreen createState() => ViralScreen();
}

class ViralScreen extends State<MyViralPage> {
  Widget build(BuildContext context) {
    return Scaffold(
